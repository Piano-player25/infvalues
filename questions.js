questions =  [
    {"id": 0, "question": "Corporations should be a dominant ruling force.", "effects": {"cap": 1, "auth": 1}},
    {"id": 1, "question": "Inheritance is a legitimate form of wealth.", "effects": {"cap": 1}},
    {"id": 2, "question": "Capitalism is the most successful and beneficial economic system yet.", "effects": {"cap": 2}},
    {"id": 3, "question": "The means of production should belong to the workers.", "effects": {"cap": -1, "hier": -1}},
    {"id": 4, "question": "Basic utilities like roads and electricity should be publicly owned.", "effects": {"cap": -1, "free": -1}},
    {"id": 5, "question": "A community should suffer the gains and loss toghether.", "effects": {"cap": -1, "nih": -1}},
    {"id": 6, "question": "A strong and large government is the best for society.", "effects": {"auth": 1}},
    {"id": 7, "question": "Even when protesting an authoritarian government, violence cannot be accepted.", "effects": {"auth": 1, "nonv": 1}},
    {"id": 8, "question": "Law and Order is more important than freedom and liberty.", "effects": {"auth": 1, "prud": 1}},    
    {"id": 9, "question": "If a state exists, its size should be minimized.", "effects": {"auth": -1}},
    {"id": 10, "question": "The government should stay out of people's daily lives.", "effects": {"auth": -1, "gadsen": 1}},
    {"id": 11, "question": "The existence of the state itself is a threat to our liberty.", "effects": {"auth": -2}},
    {"id": 12, "question": "Autocracy is better than Liberal Democracy.", "effects": {"auth": 1, "const": 1}},
    ...
    {"id": 14, "question": "Wars do not need to be justified towards other countries.", "effects": {"nat": 1, "nonv": -2}},
    {"id": 15, "question": "Nationalism is a selfish and evil ideology.", "effects": {"nat": -2}},
    {"id": 16, "question": "We should try to avoid wars and conflicts as much as possible.", "effects": {"nonv": 1, "inter": -2}},
    {"id": 17, "question": "A global country will be great for humanity.", "effects": {"nat": -1}},
    {"id": 18, "question": "Maintaining national culture is very important.", "effects": {"nat": 1, "trad": 1}},
    {"id": 19, "question": "We should maintain traditional values as much as possible.", "effects": {"trad": 1}},
    {"id": 20, "question": "We should not chase societal progress.", "effects": {"trad": 1}},
    {"id": 21, "question": "Society should be changed or reformed.", "effects": {"trad": -1}},
    {"id": 22, "question": "I support the LGBT community.", "effects": {"trad": -1, "prud": -1}},
    ...
    {"id": 26, "question": "Life is harder and generally worse than it is a few decades ago.", "effects": {"acc": -1, "trad": 1}},
    ...
    {"id": 30, "question": "My religion should be spread as much as possible.", "effects": {"relig": 2, "interv": 1}},
    {"id": 31, "question": "I consider myself religious.", "effects": {"relig": 1}},
    {"id": 32, "question": "A religious government should be put in place.", "effects": {"relig": 1, "auth": 1}},
    {"id": 33, "question": "Churches or other religious organization should be taxed as much as other organizations are.", "effects": {"relig": -1, "ptax": -1}},
    {"id": 34, "question": "My political ideas are fundementally different from the status quo.", "effects": {"rad": 1}},
    {"id": 35, "question": "A certain amount of violence is required in order to establish my ideology.", "effects": {"rad": 1, "nonv": -1}},
    ...
    {"id": 45, "question": "If computers become smarter than humans, computers should rule.", "effects": {"noo": 1, "acc": 1}},
    ...
    {"id": 49, "question": "Strong leaderships maximizes the effiency of a nation.", "effects": {"const": 1, "auth": 1}},
    {"id": 50, "question": "The best ideology is different for every nation.", "effects": {"inter": -1}},
    {"id": 51, "question": "Tyrannical governments should be toppled.", "effects": {"inter": -1, "const": -1}},
    {"id": 52, "question": "Intervention is generally beneficial.", "effects": {"inter": 2}},
    {"id": 53, "question": "Globalization is inevitable, and it nust be embraced.", "effects": {"nat": -1, "trade": 1}},
    {"id": 54, "question": "If certain people migrated into our countries, it's important for them to assimilate into our culture.", "effects": {"assi": 1, "trad": 1}},
    {"id": 55, "question": "Each ethnicity should stay in their own communities.", "effects": {"assi": 1, "open": -1}},
    {"id": 56, "question": "It's important that society is racially and ethnically diverse.", "effects": {"assi": -2}},
    ...
    {"id": 60, "question": "We need to be more open towards radical ideas.", "effects": {"prag": -1, "rad": 1}},
    {"id": 61, "question": "We should strive towards a utopian society.", "effects": {"prag": -1}},
    {"id": 62, "question": "Selfishness is a negative trait.", "effects": {"nih": 1, "cap": -1}},
    {"id": 63, "question": "Working for the community is more important than finding happiness.", "effects": {"prud": 1, "nih": 2}},
    {"id": 64, "question": "Everybody should be able to do what ever they want to do.", "effects": {"prud": -1, "auth": -1}},
    {"id": 65, "question": "Some acts are objectively disgusting.", "effects": {"prud": 2}},
    ...
    {"id": 69, "question": "The market regulates itself if the government steps away from the economy.", "effects": {"free": 2}},
    {"id": 70, "question": "It is necessary for the government to intervene in the economy to protect consumers.", "effects": {"free": -1}},
    {"id": 71, "question": "If corporations exist, they should mostly be state-owned.", "effects": {"free": -1, "cap": -2}},
    ...
    {"id": 74, "question": "Older people often have more experience and knowledge.", "effects": {"pat": 1, "trad": 1}},
    {"id": 75, "question": "If a child voluntary chooses to work, they should be allowed to work.", "effects": {"pat": -1, "free": 1}},
    {"id": 76, "question": "Young people are currently too excluded from many things.", "effects": {"pat": -2}},
    {"id": 77, "question": "Society doesn't need to be organized.", "effects": {"unru": 1}},
    {"id": 78, "question": "The current law system is too strict and absolute.", "effects": {"unru": 1, "consq": 1}},
    ...
    {"id": 83, "question": "I have broken the law before.", "effects": {"unru": 1, "auth": -1}},
    ...
    {"id": 95, "question": "My ideology could seem unworkable or scary to some people.", "effects": {"rad": 1, "contra": 1}},
    ...
    {"id": 104, "question": "I support the death penalty.", "effects": {"puni": 1, "trad": 1}},
    {"id": 105, "question": "Rehablitation is more important than punishment.", "effects": {"puni": -1}},
    {"id": 106, "question": "The current law system is too strict.", "effects": {"puni": -1, "auth": -1}},
    ...
    {"id": 111, "question": "Life was much better a few decades ago.", "effects": {"lcen": 1, "trad": 1}},
    ...
    {"id": 114, "question": "The future for human civilization looks bright.", "effects": {"lcen": 1, "trad": -1}},
    ...
    {"id": 117, "question": "It would be best if the birth rate was higher than it is currently.", "effects": {"pron": 2}},
    {"id": 118, "question": "Life is short but meaningful, we should not waste it.", "effects": {"pron": 1}},
    {"id": 119, "question": "A woman should be able to choose to abort a fetus.", "effects": {"pron": -1, "auth": -1}},
    {"id": 120, "question": "Life has no real meaning.", "effects": {"pron": -1, "spir": -1}},
    {"id": 121, "question": "It would be better if humans were extinct.", "effects": {"pron": -2}},
    ...
    {"id": 130, "question": "We should slow down or reverse human progression in order to save the environment.", "effects": {"clim": -2, "trad": 1}},
    ...
    {"id": 133, "question": "Taxation is theft.", "effects": {"ptax": -1, "cap": 1}},
    {"id": 134, "question": "The majority of a person's income should be go to taxes.", "effects": {"ptax": 1, "cap": -1}},
    {"id": 135, "question": "I enjoy art that has a futuristic look.", "effects": {"pmart": 1}},
    {"id": 136, "question": "Postmodern expressionism is too underappreciated.", "effects": {"pmart": 1, "trad": -1}},
    {"id": 137, "question": "Abstract art isn't art.", "effects": {"pmart": -1, "trad": 1}},
    {"id": 134, "question": "Art from the Renaissance is better than modern art.", "effects": {"pmart": -1, "trad": 1}},
    {"id": 134, "question": "Medieval Art looks good.", "effects": {"pmart": -1, "trad": 2}},
    ...
    {"id": 138, "question": "Work can be an enjoyable experience, as long as any person finds the right job for them.", "effects": {"enth": 1, "cap": 1}},
    {"id": 139, "question": "Companies should be encouraged to reduce working hours.", "effects": {"enth": -1, "cap": -1}},
    ...
    {"id": 143, "question": "The freedom of speech needs to protected.", "effects": {"ahs": -1, "auth": -1}},
    {"id": 144, "question": "Any person should be able to say whatever they want without consequences.", "effects": {"ahs": -1, "auth": -1}},
    {"id": 145, "question": "Most decisions should be made according to logic, even if it makes people unhappy.", "effects": {"fact": 1, "noo": 1}},
    {"id": 146, "question": "Some opinions are just truer than others.", "effects": {"fact": 1}},
    {"id": 147, "question": "A decision is always bad if all people are against it.", "effects": {"fact": -1, "noo": -1}},
    ...
    {"id": 151, "question": "Weapons should be privatized through a free market.", "effects": {"wmar": 1, "ptax": -1}},
    {"id": 152, "question": "Only corporations should have the ability to own weapons.", "effects": {"wmar": 1, "cap": 2}},
    {"id": 153, "question": "Certain weapons should be banned.", "effects": {"wmar": 1, "auth": 1}},
    {"id": 153, "question": "Every worker should own weapons.", "effects": {"wmar": -1, "cap": -1}},
    {"id": 154, "question": "Free trade benefits both sides in most cases.", "effects": {"trade": 1, "free": 1}},
    {"id": 155, "question": "Free trade is one of the best methods for an undeveloped country to escape poverty.", "effects": {"trade": 1, "free": 1}},
    {"id": 156, "question": "The negative impacts of tariffs outweigh its positive impacts.", "effects": {"trade": -1, "free": -1}},
    {"id": 157, "question": "Free trade often harms local businesses and workers.", "effects": {"trade": -1, "nat": 1}},
    {"id": 158, "question": "If a society becomes too open-minded, society would become unstable and unsafe.", "effects": {"cmind": 1, "auth": 1}},
    ...
    {"id": 161, "question": "Killing animals for food isn't immoral.", "effects": {"poach": 1, "trad": 1}},
    {"id": 162, "question": "There should be stricter laws on killing animals.", "effects": {"poach": -1, "trad": -1}},
    {"id": 163, "question": "The workplace should be hierarchial.", "effects": {"hier": 1, "cap": 1}},
    {"id": 164, "question": "The owner of a business should own the means of production, because he took the risks of bankrupcy.", "effects": {"hier": 1, "cap": 1}},
    {"id": 165, "question": "Workplaces should be worker-owned.", "effects": {"hier": -1, "cap": -1}},
    {"id": 166, "question": "The interests of a nation's legal citizens are more important than the interests of immigrants.", "effects": {"open": -1, "nat": 1}},
    {"id": 167, "question": "Walls and fences should be set up in order to stop illegal immigration.", "effects": {"open": -1, "nat": 1}},
    {"id": 168, "question": "We should make immigration easier.", "effects": {"open": 1, "nat": -1}},
    ...
    {"id": 170, "question": "Young people should rule this country.", "effects": {"pat": -2, "const": 1}},
    {"id": 171, "question": "Using technological implants to increase the intelligence of the population would not be a bad idea.", "effects": {"trpop": -2, "acc": 1}},
    {"id": 172, "question": "Immigration is a good thing for the economy.", "effects": {"open": 1, "free": 1}},
    {"id": 173, "question": "Worker cooperatives are more efficient than traditional businesses.", "effects": {"hier": -2}},
    {"id": 174, "question": "Most \"criminals\" did nothing wrong.", "effects": {"puni": -2, "unru": 1}},
    {"id": 175, "question": "I would rather live in a communist society than in a communalist society.", "effects": {"cap": 1, "rad": -1}},
    {"id": 176, "question": "Autarky is a sensible form of economics.", "effects": {"open": -1, "trade": -2}},
